package cn.tech.wings.cloud.common.core.exception;
...
public interface ErrorCodes {
	 ...
	 * 用户手机号为空
	 */
	String SYS_USER_PHONE_EMPTY = "sys.user.userPhone.empty";

	/**
	 * 用户名为空
	 */
	String SYS_USER_NAME_EMPTY = "sys.user.userName.empty";

	/**
	 * 角色为空
	 */
	String SYS_USER_ROLE_EMPTY = "sys.user.userRole.empty";

	/**
	 * 部门名称为空
	 */
	String SYS_USER_DEPTNAME_EMPTY = "sys.user.deptname.empty";
	...
	String SYS_CASE_IMPORT_SUCCEED = "sys.case.import.succeed";
	String SYS_CASE_USERNAME_EXISTING = "sys.case.caseCode.existing";
	String SYS_CASE_IMPORT_CODE_EMPTY = "sys.case.import.code.empty";
