package cn.tech.wings.cloud.test;

import cn.hutool.core.util.StrUtil;
import cn.hutool.http.HttpUtil;
import cn.hutool.json.JSONUtil;
import cn.tech.wings.cloud.test.annotation.WithMockOAuth2User;
...
public class WithMockSecurityContextFactory implements WithSecurityContextFactory<WithMockOAuth2User> {
	...
	private final String TOKEN_URL = "http://cloud-auth/oauth/token";
